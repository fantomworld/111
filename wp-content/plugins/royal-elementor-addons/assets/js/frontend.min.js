    ...
    var e = {
        ...
        widgetSection: function(i) {
            function a(t) {
                var a = JSON.parse(t),
                    ...
                    l = e.editorCheck() ? i.find(".wpr-particle-wrapper").attr("wpr-size") : i.attr("wpr-size");
                return a.particles.size.value = l, a.particles.number.value = r, a.particles.color.value = s, a.particles.shape.type = o, a.particles.line_linked.color = s, a.particles.move.speed = n, a
            }
            if ((i.attr("data-wpr-particles") || i.find(".wpr-particle-wrapper").attr("data-wpr-particles-editor")) && function() {
                    ...
                    "section" === t && void 0 !== s && (e.editorCheck() ? i.hasClass("wpr-particle-yes") ? (particlesJS("wpr-particle-" + r, "wpr_particle_json_custom" == i.find(".wpr-particle-wrapper").attr("particle-source") ? JSON.parse(s) : a(s)), i.find(".elementor-column").css("z-index", 9), setTimeout(function() {
                        window.dispatchEvent(new Event("resize"))
                    }, 500)) : i.find(".wpr-particle-wrapper").remove() : (i.prepend("<div class=\"wpr-particle-wrapper\" id=\"wpr-particle-" + r + "\"></div>"), particlesJS("wpr-particle-" + r, "wpr_particle_json_custom" == i.attr("particle-source") ? JSON.parse(s) : a(s)), setTimeout(function() {
                        window.dispatchEvent(new Event("resize"))
                    }, 500)))
                ...
                function a() {
                    if (!i.hasClass("wpr-sticky-section-yes") || !i.find(".wpr-sticky-section-yes-editor")) return void(r = "static");
                    var e = [],
                        t = [
                            ["mobile_sticky", 768],
                    ...
                    t.forEach((t, i) => {
                        t[1] > d && -1 === p.indexOf(t[0]) ? (r = -1 === c ? .indexOf(t[0]) ? e[i - 1] ? e[i - 1] : n : "static", e[i] = r) : t[1] > d && -1 !== p.indexOf(t[0]) && (r = n)
                    }), u()
                }
                ...
                function u() {
                    ...
                    "top" === o ? (i.css({
                        ...
                        position: r
                    }), "" !== w && (w = w.find(".wpr-sticky-section-yes"), w.css({
                        position: r,
                        bottom: l + "px",
                        top: "auto",
                        "z-index": m,
                ...
                function y() {
                    t("#wpadminbar").length && (s = t("#wpadminbar").css("height").slice(0, t("#wpadminbar").css("height").length - 2), "top" === o && ("fixed" == i.css("position") || "sticky" == i.css("position")) && (i.css("top", +s + g + "px"), i.css("bottom", "auto")))
                }
                var r, s, n = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-position-type") : i.attr("data-wpr-position-type"),
                    o = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-position-location") : i.attr("data-wpr-position-location"),
                    l = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-position-offset") : i.attr("data-wpr-position-offset"),
                    ...
                    w = i.closest("div[data-elementor-type=\"wp-post\"]").length ? i.closest("div[data-elementor-type=\"wp-post\"]") : "",
                    m = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-z-index") : i.attr("data-wpr-z-index");
                if (i.find(".wpr-sticky-section-yes-editor").length || (n = i.attr("data-wpr-position-type"), o = i.attr("data-wpr-position-location"), l = i.attr("data-wpr-position-offset"), p = i.attr("data-wpr-sticky-devices"), c = i.attr("data-wpr-active-breakpoints"), m = i.attr("data-wpr-z-index")), "top" === o && "auto" === i.css("top")) {
                    var g = 0;
                    i.css("top", 0)
                } else var g = +i.css("top").slice(0, -2);
                if (0 == p.length && (n = "static"), e.editorCheck() && p) {
                    var h = i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-sticky-devices");
                    i.attr("data-wpr-sticky-devices", h), p = i.attr("data-wpr-sticky-devices")
                }
                a(), y(), t(window).resize(function() {
                    d = t("body").prop("clientWidth") + 17, a()
                }), f || (r = "static")
            }
        },
        widgetNavMenu: function(i) {
            ...
            var s = i.find(".wpr-nav-menu-container"),
                ...
                l = s.find(".wpr-sub-menu li.menu-item-has-children");
            i.find(".wpr-mobile-toggle").length && i.find("a").on("click", function() {
                ...
                s.hasClass("wpr-nav-menu-horizontal") && r(l.find(".wpr-sub-menu"), !1), e.hasClass("wpr-sub-open") ? (e.removeClass("wpr-sub-open"), r(a, !1)) : (i.preventDefault(), e.addClass("wpr-sub-open"), r(a, !0))
            }), t(document).mouseup(function(t) {
                o.is(t.target) || 0 !== o.has(t.target).length || (o.not().removeClass("wpr-sub-open"), r(o.children(".wpr-sub-menu"), !1)), l.is(t.target) || 0 !== l.has(t.target).length || (l.removeClass("wpr-sub-open"), r(l.children(".wpr-sub-menu"), !1))
        ...
        widgetMegaMenu: function(i) {
            ...
            var o = i.find(".wpr-nav-menu-container"),
                ...
                d = o.find(".wpr-nav-menu > li.menu-item-has-children"),
                p = o.find(".wpr-sub-menu li.menu-item-has-children");
            i.find(".wpr-mobile-toggle").length && i.find("a").on("click", function() {
                this.pathname != window.location.pathname || 1 < t(this).parent("li").children().length || i.find(".wpr-mobile-toggle").trigger("click")
            }), "click" === o.attr("data-trigger") ? (d.children("a").on("click", function(i) {
                var e = t(this).parent(),
                    a = e.children(".wpr-sub-menu, .wpr-sub-mega-menu");
                d.not(e).removeClass("wpr-sub-open"), (o.hasClass("wpr-nav-menu-horizontal") || o.hasClass("wpr-nav-menu-vertical")) && s(d.children(".wpr-sub-menu, .wpr-sub-mega-menu"), !1), e.hasClass("wpr-sub-open") ? (e.removeClass("wpr-sub-open"), s(a, !1)) : (i.preventDefault(), e.addClass("wpr-sub-open"), s(a, !0))
                ...
                d.is(t.target) || 0 !== d.has(t.target).length || (d.not().removeClass("wpr-sub-open"), s(d.children(".wpr-sub-menu, .wpr-sub-mega-menu"), !1)), p.is(t.target) || 0 !== p.has(t.target).length || (p.removeClass("wpr-sub-open"), s(p.children(".wpr-sub-menu"), !1))
            ...
            var c = l.find(".wpr-mobile-nav-menu");
            l.find(".wpr-mobile-toggle").on("click", function() {
                t(this).hasClass("wpr-mobile-toggle-open") ? (t(this).removeClass("wpr-mobile-toggle-open"), t(this).trigger("focusout"), t(this).find(".wpr-mobile-toggle-text").length && (t(this).children().eq(1).hide(), t(this).children().eq(0).show())) : (t(this).addClass("wpr-mobile-toggle-open"), t(this).find(".wpr-mobile-toggle-text").length && (t(this).children().eq(0).hide(), t(this).children().eq(1).show())), i.hasClass("wpr-mobile-menu-display-offcanvas") ? (t("body").css("overflow", "hidden"), t(this).parent().siblings(".wpr-mobile-mega-menu-wrap").toggleClass("wpr-mobile-mega-menu-open")) : t(this).parent().siblings(".wpr-mobile-mega-menu-wrap").stop().slideToggle(), i.find(".mobile-mega-menu-close").on("click", function() {
                    t(this).closest(".wpr-mobile-mega-menu-wrap").removeClass("wpr-mobile-mega-menu-open"), t("body").css("overflow", "visible")
                }), i.find(".wpr-mobile-mega-menu-overlay").on("click", function() {
                    t(this).siblings(".wpr-mobile-mega-menu-wrap").removeClass("wpr-mobile-mega-menu-open"), t("body").css("overflow", "visible")
                }), r()
        ...
        OnepageNav: function(e) {
            t(document).ready(function() {
                function i(i) {
                    "yes" !== e.find(".wpr-onepage-nav").attr("data-highlight") || (e.find(".wpr-onepage-nav").find("a").removeClass("wpr-onepage-active-item"), t(".elementor-section").each(function() {
                        var a = t(this).offset().top,
                            r = a + t(this).outerHeight();
                        i >= a && i < r && e.find(".wpr-onepage-nav").find("a[href=\"#" + t(this).attr("id") + "\"]").addClass("wpr-onepage-active-item")
                    }))
                }
                e.find(".wpr-onepage-nav-item").on("click", function(e) {
                    e.preventDefault();
                    var a = t(t(this).find("a").attr("href")),
                        r = parseInt(t(this).parent().attr("data-speed"), 10);
                    a && t("html, body").animate({
                        scrollTop: a.offset().top
                    }, r), i(t(window).scrollTop())
        ...
        widgetGrid: function(a) {
            ...
            function s() {
                "yes" !== f.find(".wpr-grid-media-wrap").attr("data-overlay-link") || e.editorCheck() || (f.find(".wpr-grid-media-wrap").css("cursor", "pointer"), f.find(".wpr-grid-media-wrap").on("click", function(e) {
                    ...
                    if (-1 !== i.indexOf("inner-block") || -1 !== i.indexOf("wpr-cv-inner") || -1 !== i.indexOf("wpr-grid-media-hover")) {
                        ...
                        var a = t(this).find(".wpr-grid-media-hover-bg").attr("data-url"),
                            a = a.replace("#new_tab", "");
                        "_blank" === f.find(".wpr-grid-item-title a").attr("target") ? window.open(a, "_blank").focus() : window.location.href = a
                    }
                }))
            }
            ...
            function n(i) {
                if (-1 !== a.find(".wpr-grid-item-lightbox").length) {
                    ...
                    r.each(function() {
                        ...
                        f.hasClass("wpr-media-grid") || i.find(".wpr-grid-image-wrap").attr("data-src", e);
                        var a = i.find(".wpr-grid-image-wrap").attr("data-src");
                        typeof a != "undefined" && !1 !== a && -1 === a.indexOf("wp-content") && i.find(".wpr-grid-image-wrap").attr("data-iframe", "true")
                    }), f.lightGallery(i.lightbox), f.on("onAfterOpen.lg", function() {
            ...
            function o() {
                a.find(".wpr-post-like-button").length && a.find(".wpr-post-like-button").on("click", function() {
                    var e = t(this);
            ...
            function l(e) {
                ...
                var E = +elementorFrontend.config.responsive.breakpoints.mobile.value,
                    ...
                    R = +elementorFrontend.config.responsive.breakpoints.widescreen.value,
                    N = elementorFrontend.config.responsive.activeBreakpoints;
                E >= W && null != N.mobile ? (g = h, b = _, v = x) : M >= W && null != N.mobile_extra ? (g = r ? r : u, b = C, v = k) : V >= W && null != N.tablet ? (g = u, b = T, v = S) : H >= W && null != N.tablet_extra ? (g = s ? s : u, b = z, v = A) : F >= W && null != N.laptop ? (g = n ? n : y, b = q, v = P) : R > W ? (g = y, b = e.gutter_hr, v = e.gutter_vr) : (g = o ? o : y, b = j, v = O), 8 < g && (g = 8), "string" == typeof g && -1 !== g.indexOf("pro") && (g = 3), D = l.width() + b - .3, d.outerWidth(Math.floor(D / g - b)), d.css("margin-bottom", v + "px"), 1 === g && d.last().css("margin-bottom", "0");
                var G = -1;
                if (p.each(function() {
                    ...
                    var U = d.find(".wpr-grid-image-wrap").outerHeight();
                    if (d.find(".wpr-grid-item-below-content").css("min-height", U + "px"), 480 > t("body").prop("clientWidth")) d.find(".wpr-grid-media-wrap").css({
                        float: "none",
                        width: "100%"
                        ...
                        var X = "left" === f ? "margin-right" : "margin-left";
                        d.find(".wpr-grid-media-wrap").css(X, m + "px"), d.find(".wpr-grid-item-below-content").css({
                            float: f,
                        ...
                        float: "left",
                        width: "calc((100% - " + w + "%) - " + m + "px)"
                    }), d.filter(":even").find(".wpr-grid-media-wrap").css("margin-right", m + "px"), d.filter(":odd").find(".wpr-grid-media-wrap").css({
                        float: "right",
                        width: w + "%"
                    }), d.filter(":odd").find(".wpr-grid-item-below-content").css({
                        float: "right",
                        width: "calc((100% - " + w + "%) - " + m + "px)"
                    }), d.filter(":odd").find(".wpr-grid-media-wrap").css("margin-left", m + "px"), l.hasClass("wpr-grid-list-ready") || d.each(function(e) {
                        ...
                        l.hasClass("wpr-grid-list-ready") || l.addClass("wpr-grid-list-ready")
                    }, 500)
                }
                "list" === c && (c = "fitRows"), "default" !== e.filters_animation && (I = 0);
                l.isotopewpr({
                    layoutMode: c,
                    masonry: {
                        comlumnWidth: D / g,
            ...
            function d() {
                setTimeout(function() {
                    ...
                    a.find(".wpr-grid-image-wrap img").each(function() {
                        e.observe(t(this)[0])
                    })
                }, 100)
            }
            ...
            function p(e) {
                if ("yes" === e.filters_count && a.find(".wpr-grid-filters a, .wpr-grid-filters span").each(function() {
                    ...
                    "yes" === e.filters_hide_empty && a.find(".wpr-grid-filters span").each(function() {
                        ...
                        "*" !== e && (0 === f.find(e).length ? t(this).parent("li").addClass("wpr-hidden-element") : t(this).parent("li").removeClass("wpr-hidden-element"))
                    }), a.hasClass("elementor-widget-wpr-woo-category-grid-pro") || "" === e.filters_default_filter || setTimeout(function() {
                        ...
                        "infinite-scroll" === e.pagination_type && 0 === f.find(t(this).attr("data-filter")).length && a.find(".wpr-grid").infiniteScroll("loadNextPage"), "load-more" === e.pagination_type && 0 === f.find(t(this).attr("data-filter")).length && a.find(".wpr-grid").infiniteScroll("loadNextPage"), "default" !== e.filters_animation && a.find(".wpr-grid-item-inner").css({
                            opacity: "0",
                            transition: "none"
                            ...
                            filter: i
                        }), e.lightbox.selector = "*" === i ? " .wpr-grid-image-wrap" : i + " .wpr-grid-image-wrap", f.data("lightGallery").destroy(!0), f.lightGallery(e.lightbox)
                    })
                }
            }
            var c, f = a.find(".wpr-grid");
            if (f.length) {
                if (a.find(".woocommerce-result-count").length) {
                    var w = a.find(".woocommerce-result-count").text();
                    w = w.replace(/\d\u2013\d+/, "1\u2013" + a.find(".wpr-grid-item").length), a.find(".woocommerce-result-count").text(w)
                }
                var m = f.attr("data-settings");
                if (a.find(".wpr-grid-orderby form").length) {
                    var g = a.find(".wpr-grid-orderby form");
                    a.find(".orderby").on("change", function() {
                        g.trigger("submit")
                    })
                }
                if ("undefined" != typeof m && !1 !== m) {
                    m = JSON.parse(f.attr("data-settings")), l(m), setTimeout(function() {
                        l(m)
                    ...
                    var h = 0;
                    if (f.on("arrangeComplete", function(e, i) {
                            var r = 0,
                                s = 0,
                                n = 0,
                                o = m.animation_duration,
                                l = m.filters_animation_duration;
                            if (f.hasClass("grid-images-loaded")) n = 0;
                            else if (f.css("opacity", "1"), "default" === m.animation && "default" === m.filters_animation) return;
                            for (var d in i) {
                                (0 == h || d > h - 1) && (n += m.animation_delay, a.find(i[d].element).find(".wpr-grid-item-inner").css({
                                    opacity: "1",
                                    top: "0",
                                    transform: "scale(1)",
                                    transition: "all " + o + "s ease-in " + n + "s"
                                })), s += m.filters_animation_delay, f.hasClass("grid-images-loaded") && a.find(i[d].element).find(".wpr-grid-item-inner").css({
                                    transition: "all " + l + "s ease-in " + s + "s"
                                });
                                var p = window.location.hash;
                                0 <= p.indexOf("#filter:") && 0 > p.indexOf("#filter:*") && (p = p.replace("#filter:", ""), a.find(i[d].element).filter(function() {
                                    if (t(this).hasClass(p)) return r += m.filters_animation_delay, t(this)
                            ...
                            "1" !== f.css("opacity") && f.css("opacity", "1"), setTimeout(function() {
                                f.addClass("grid-images-loaded")
                            }, 500)
                        }), ("load-more" === m.pagination_type || "infinite-scroll" === m.pagination_type) && a.find(".wpr-grid-pagination").length && !e.editorCheck()) {
                        var u = a.find(".wpr-grid-pagination"),
                            y = ".elementor-element-" + a.attr("data-id"),
                            b = !1,
                            v = !1;
                        "infinite-scroll" === m.pagination_type && (v = 300, b = y + " .wpr-load-more-btn"), f.infiniteScroll({
                            path: y + " .wpr-grid-pagination a",
                            hideNav: b,
                            append: !1,
                            history: !1,
                            scrollThreshold: v,
                            status: y + " .page-load-status",
                            onInit: function() {
                                this.on("load", function() {
                                    f.removeClass("grid-images-loaded")
                                })
                            }
                        }), f.on("request.infiniteScroll", function() {
                            u.find(".wpr-load-more-btn").hide(), u.find(".wpr-pagination-loading").css("display", "inline-block")
                        });
                        var _ = 0;
                        f.on("load.infiniteScroll", function(e, i) {
                            _++;
                            var w = t(i).find(y).find(".wpr-grid-item");
                            if (a.find(".woocommerce-result-count").length) {
                                var g = a.find(".woocommerce-result-count").text(),
                                    h = g.replace(/\d\u2013\d+/, "1\u2013" + (a.find(".wpr-grid-item").length + w.length));
                                a.find(".woocommerce-result-count").text(h)
                            }
                            if (f.infiniteScroll("appendItems", w), f.isotopewpr("appended", w), w.imagesLoaded().progress(function() {
                                    l(m), setTimeout(function() {
                                        l(m), p(m)
                                    }, 10), setTimeout(function() {
                                        f.addClass("grid-images-loaded")
                                    }, 500)
                                }), u.find(".wpr-pagination-loading").hide(), m.pagination_max_pages - 1 === _) u.find(".wpr-pagination-finish").fadeIn(1e3), u.delay(2e3).fadeOut(1e3), setTimeout(function() {
                                u.find(".wpr-pagination-loading").hide()
                            }, 500);
                            else if ("load-more" === m.pagination_type && (u.find(".wpr-load-more-btn").fadeIn(), "*" !== a.find(".wpr-active-filter").attr("data-filter"))) {
                                let e = a.find(".wpr-active-filter").attr("data-filter").substring(1);
                                w.each(function() {
                                    return t(this).hasClass(e) ? (c = !0, !1) : void(c = !1)
                                }), c || a.find(".wpr-grid").infiniteScroll("loadNextPage")
                            }
                            setTimeout(function() {
                                o(m)
                            }, 300), n(m), f.data("lightGallery").destroy(!0), f.lightGallery(m.lightbox), s(), r(), d()
                        }), u.find(".wpr-load-more-btn").on("click", function() {
                            return f.infiniteScroll("loadNextPage"), !1
                        })
                    }
                } else {
                    f.animate({
                        opacity: "1"
                    }, 1e3), m = JSON.parse(f.attr("data-slick"));
                    var x = a.attr("class"),
                        C = x.match(/wpr-grid-slider-columns-\d/) ? x.match(/wpr-grid-slider-columns-\d/).join().slice(-1) : 2,
                        k = x.match(/columns--widescreen\d/) ? x.match(/columns--widescreen\d/).join().slice(-1) : C,
                        T = x.match(/columns--laptop\d/) ? x.match(/columns--laptop\d/).join().slice(-1) : C,
                        S = x.match(/columns--tablet\d/) ? x.match(/columns--tablet\d/).join().slice(-1) : 2,
                        z = x.match(/columns--tablet_extra\d/) ? x.match(/columns--tablet_extra\d/).join().slice(-1) : S,
                        A = x.match(/columns--mobile_extra\d/) ? x.match(/columns--mobile_extra\d/).join().slice(-1) : S,
                        j = x.match(/columns--mobile\d/) ? x.match(/columns--mobile\d/).join().slice(-1) : 1,
                        O = m.sliderSlidesToScroll;
                    f.slick({
                        ...
                        responsive: [{
                            ...
                            settings: {
                                slidesToShow: k,
                                slidesToScroll: O > k ? 1 : O
                            }
                        }, {
                            breakpoint: 2399,
                            settings: {
                                slidesToShow: C,
                                slidesToScroll: O > C ? 1 : O
                            }
                        }, {
                            breakpoint: 1221,
                            settings: {
                                slidesToShow: T,
                                slidesToScroll: O > T ? 1 : O
                            }
                        }, {
                            breakpoint: 1200,
                            settings: {
                                slidesToShow: z,
                                slidesToScroll: O > z ? 1 : O
                            }
                        }, {
                            breakpoint: 1024,
                            settings: {
                                slidesToShow: S,
                                slidesToScroll: O > S ? 1 : O
                            }
                        }, {
                            breakpoint: 880,
                            settings: {
                                slidesToShow: A,
                                slidesToScroll: O > A ? 1 : O
                            }
                        }, {
                            breakpoint: 768,
                            settings: {
                                slidesToShow: j,
                                slidesToScroll: O > j ? 1 : O
                            }
                        }]
                    });
                    var q = a.find(".wpr-grid-slider-prev-arrow"),
                        P = a.find(".wpr-grid-slider-next-arrow");
                    if (0 < q.length && 0 < P.length) {
                        var D = -2 * q.position().left;
                        0 < D && (t(window).on("load", function() {
                            t(window).width() <= a.outerWidth() + q.outerWidth() + P.outerWidth() + D && (q.addClass("wpr-adjust-slider-prev-arrow"), P.addClass("wpr-adjust-slider-next-arrow"))
                        }), t(window).smartresize(function() {
                            t(window).width() <= a.outerWidth() + q.outerWidth() + P.outerWidth() + D ? (q.addClass("wpr-adjust-slider-prev-arrow"), P.addClass("wpr-adjust-slider-next-arrow")) : (q.removeClass("wpr-adjust-slider-prev-arrow"), P.removeClass("wpr-adjust-slider-next-arrow"))
                        }))
                    }
                    if (a.find(".slick-dots").length && a.hasClass("wpr-grid-slider-dots-horizontal")) {
                        var W = a.find(".slick-dots li").outerWidth() * a.find(".slick-dots li").length - parseInt(a.find(".slick-dots li span").css("margin-right"), 10);
                        a.find(".slick-dots").length && a.find(".slick-dots").css("width", W), t(window).smartresize(function() {
                            setTimeout(function() {
                ...
                if (f.find(".wpr-grid-item-add-to-cart").length) {
                    var I = f.find(".wpr-grid-item-add-to-cart").find("i"),
                        B = I.attr("class");
                    I.length && (B = B.substring(B.indexOf("fa-"), B.length)), t("body").on("adding_to_cart", function(e, t) {
                        t.fadeTo("slow", 0)
                    }), t("body").on("added_to_cart", function(e, i, a, r) {
                        if (r.next().fadeTo(700, 1), r.css("display", "none"), "sidebar" === r.data("atc-popup")) t(".wpr-mini-cart-toggle-wrap a").length && t(".wpr-mini-cart-toggle-wrap a").each(function() {
                            "none" === t(this).closest(".wpr-mini-cart-inner").find(".wpr-mini-cart").css("display") && t(this).trigger("click")
                        });
                        else if ("popup" === r.data("atc-popup")) {
                            var s, n, o = r.closest(".wpr-grid-item"),
                                l = o.find(".wpr-grid-item-title").text(),
                                d = r.next().attr("href"),
                                p = o.find(".wpr-grid-image-wrap").length ? o.find(".wpr-grid-image-wrap").data("src") : "",
                                c = r.data("atc-animation"),
                                f = r.data("atc-fade-out-in"),
                                w = r.data("atc-animation-time"),
                                m = "wpr-added-to-cart-default";
                            "slide-left" === c ? (m = "wpr-added-to-cart-slide-in-left", n = "wpr-added-to-cart-slide-out-left") : "scale-up" === c ? (m = "wpr-added-to-cart-scale-up", n = "wpr-added-to-cart-scale-down") : "skew" === c ? (m = "wpr-added-to-cart-skew", n = "wpr-added-to-cart-skew-off") : "fade" === c ? (m = "wpr-added-to-cart-fade", n = "wpr-added-to-cart-fade-out") : n = "wpr-added-to-cart-popup-hide", s = "" === p ? "" : "<div class=\"wpr-added-tc-popup-img\"><img src=" + p + " alt=\"\" /></div>", t(this).find(".wpr-grid").append("<div class=\"wpr-added-to-cart-popup " + m + "\">" + s + "<div class=\"wpr-added-tc-title\"><p>" + l + " was added to cart</p><p><a href=" + d + ">View Cart</a></p></div></div>"), setTimeout(() => {
                                t(this).find(".wpr-added-to-cart-popup").addClass(n), setTimeout(() => {
                                    t(this).find(".wpr-added-to-cart-popup").remove()
                                }, 1e3 * w)
                            }, 1e3 * f)
                        }
                        I.length && (r.find("i").removeClass(B).addClass("fa-check"), setTimeout(function() {
                            r.find("i").removeClass("fa-check").addClass(B)
                        }, 3500))
                    })
                }
                r(), s(), a.hasClass("elementor-widget-wpr-woo-category-grid-pro") || n(m), o(m), d()
            }
        },
        widgetMagazineGrid: function(i) {
            ...
            if ("yes" !== a.find(".wpr-grid-media-wrap").attr("data-overlay-link") || e.editorCheck() || (a.find(".wpr-grid-media-wrap").css("cursor", "pointer"), a.find(".wpr-grid-media-wrap").on("click", function(e) {
                ...
                o.first().find("a").each(function() {
                    l += t(this).outerWidth() + parseInt(t(this).css("margin-right"), 10)
                });
                var d = parseInt(o.find("a").css("margin-right"), 10);
                "left" === n.attr("data-direction") ? (o.css("width", l + "px"), o.css("left", -(d + l) + "px")) : "right" === n.attr("data-direction") ? (o.css("width", l + "px"), o.css("right", -(d + l) + "px")) : "top" === n.attr("data-direction") ? (o.find("a").css({
                    "margin-right": "0",
                    "margin-top": d + "px"
                }), o.css({
                    top: -d + "px",
                    ...
                    "-webkit-transform": "translate(-50%, -100%)",
                    transform: "translate(-50%, -100%)"
                })) : "right" === n.attr("data-direction") ? (o.css("width", l + "px"), o.css({
                    left: d + "px"
        ...
        widgetProductMedia: function(i) {
            ...
            if (i.hasClass("wpr-product-media-thumbs-slider") && i.hasClass("wpr-product-media-thumbs-vertical")) {
                ...
                var l = i.find(".wpr-thumbnail-slider-prev-arrow"),
                    d = i.find(".wpr-thumbnail-slider-next-arrow");
                l.remove(), d.remove(), i.find(".wpr-product-media-wrap").data("slidestoshow") < i.find(".flex-control-nav li").length && (i.find(".wpr-fcn-wrap").prepend(l), i.find(".wpr-fcn-wrap").append(d));
                var p = 0,
                    c = 0;
                i.find(".wpr-thumbnail-slider-next-arrow").on("click", function() {
                    console.log(c + o, i.find(".flex-control-nav li").length - 1), c + o < i.find(".flex-control-nav li").length - 1 ? (p++, c += o, i.find(".flex-control-nav").css("transform", "translateY(" + parseInt(-p) * (parseInt(i.find(".flex-control-nav li:last-child").css("height").slice(0, -2)) + parseInt(i.find(".flex-control-nav li").css("margin-bottom"))) * o + "px)"), 1 <= p ? i.find(".wpr-thumbnail-slider-prev-arrow").attr("disabled", !1) : i.find(".wpr-thumbnail-slider-prev-arrow").attr("disabled", !0)) : (p = 0, c = 0, i.find(".flex-control-nav").css("transform", `translateY(0)`), i.find(".wpr-thumbnail-slider-prev-arrow").attr("disabled", !0))
            ...
            if (i.hasClass("wpr-product-media-thumbs-slider") && i.find(".wpr-product-media-wrap").hasClass("wpr-product-media-thumbs-horizontal")) {
                ...
                var l = i.find(".wpr-thumbnail-slider-prev-arrow"),
                    d = i.find(".wpr-thumbnail-slider-next-arrow");
                l.remove(), d.remove(), i.find(".wpr-product-media-wrap").data("slidestoshow") < i.find(".flex-control-nav li").length && (i.find(".wpr-fcn-wrap").prepend(l), i.find(".wpr-fcn-wrap").append(d), i.find(".wpr-thumbnail-slider-arrow").removeClass("wpr-tsa-hidden"));
                var f = 0,
                    c = 0;
        ...
        widgetCountDown: function(i) {
            ...
            if ("evergreen" === s.data("type")) {
                ...
                d = f.hasOwnProperty(c) ? 0 === Object.keys(f).length || o !== f[c].interval ? p.setSeconds(p.getSeconds() + o) : f[c].endTime : p.setSeconds(p.getSeconds() + o), d + l < p.setSeconds(p.getSeconds()) && (d = p.setSeconds(p.getSeconds() + o)), f[c] = {
                    interval: o,
                    endTime: d
                }, localStorage.setItem("WprCountDownSettings", JSON.stringify(f))
            }
            a(), e.editorCheck() || (n = setInterval(a, 1e3))
        },
        widgetGoogleMaps: function(e) {
            ...
            for (var r = e.find(".wpr-google-map"), s = r.data("settings"), n = r.data("controls"), o = r.data("locations"), l = [], d = new google.maps.LatLngBounds, p = new google.maps.Map(r[0], {
                    mapTypeId: s.type,
                    styles: a(s),
                    zoom: s.zoom_depth,
                ...
                if ("" != f.gm_latitude && "" != f.gm_longtitude) {
                    "yes" === f.gm_custom_marker && (w = {
                        ...
                        scaledSize: new google.maps.Size(m, g)
                    });
                    ...
                    "none" !== f.gm_show_info_window && t(h, f), l.push(h), d.extend(h.position)
                }
            }
            if (1 < o.length ? p.fitBounds(d) : p.setCenter(d.getCenter()), "yes" === s.cluster_markers) new MarkerClusterer(p, l, {
        ...
        widgetAdvancedSlider: function(e) {
            function i() {
                var e, t, i = n.find(".wpr-slider-item").outerWidth(),
                    a = n.find(".wpr-slider-item").outerHeight(),
                    r = 16 / 9,
                    s = 0,
                    o = 0;
                i / a > r ? (t = i, e = t / r, s = "-" + (e - a) / 2 + "px") : (e = a, t = e * r, o = "-" + (t - i) / 2 + "px"), n.find("iframe").css({
                    width: t + "px",
                    height: e + "px",
                    "max-width": "none",
                    position: "absolute",
            ...
            function a() {
                n.find(".slick-active").each(function() {
                    var e = t(this).attr("data-video-src"),
                        a = t(this).attr("data-video-autoplay");
                    1 !== t(this).find(".wpr-slider-video").length && "yes" === a && (1 == d ? t(this).find(".wpr-cv-inner").prepend("<div class=\"wpr-slider-video\"><iframe src=\"" + e + "\" width=\"100%\" height=\"100%\"  frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe></div>") : t(this).find(".wpr-cv-container").prepend("<div class=\"wpr-slider-video\"><iframe src=\"" + e + "\" width=\"100%\" height=\"100%\"  frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe></div>"), i())
                })
            }
            ...
            function s() {
                n.find(".slick-active").find(".wpr-slider-content").fadeIn(0), 1 == d && n.find(".slick-active").find(".wpr-slider-animation").addClass("wpr-animation-enter")
            }
            var n = e.find(".wpr-advanced-slider"),
                o = n.data("slick"),
                l = e.attr("class"),
                d = l.match(/wpr-adv-slider-columns-\d/) ? l.match(/wpr-adv-slider-columns-\d/).join().slice(-1) : 2,
                p = l.match(/columns--widescreen\d/) ? l.match(/columns--widescreen\d/).join().slice(-1) : d,
                c = l.match(/columns--laptop\d/) ? l.match(/columns--laptop\d/).join().slice(-1) : d,
                f = l.match(/columns--tablet\d/) ? l.match(/columns--tablet\d/).join().slice(-1) : 2,
                w = l.match(/columns--tablet_extra\d/) ? l.match(/columns--tablet_extra\d/).join().slice(-1) : f,
                m = l.match(/columns--mobile_extra\d/) ? l.match(/columns--mobile_extra\d/).join().slice(-1) : f,
                g = l.match(/columns--mobile\d/) ? l.match(/columns--mobile\d/).join().slice(-1) : 1,
                h = +l.match(/wpr-adv-slides-to-scroll-\d/).join().slice(-1),
                u = n.attr("data-slide-effect");
            if (n.slick({
                ...
                }), a(), s(), n.find(".wpr-slider-video-btn").on("click", function() {
                    var e = t(this).closest(".slick-active"),
                        a = e.attr("data-video-src");
                    1 !== e.find(".wpr-slider-video").length && (e.find(".wpr-cv-container").prepend("<div class=\"wpr-slider-video\"><iframe src=\"" + a + "\" width=\"100%\" height=\"100%\"  frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe></div>"), i(), e.find(".wpr-slider-content").fadeOut(300))
                }), e.find(".slick-current").addClass("wpr-slick-visible"), e.find(".slick-current").nextAll().slice(0, d - 1).addClass("wpr-slick-visible"), n.on({
                    ...
                    afterChange: function() {
                        s(), a(), e.find(".slick-slide").removeClass("wpr-slick-visible"), e.find(".slick-current").addClass("wpr-slick-visible"), e.find(".slick-current").nextAll().slice(0, d - 1).addClass("wpr-slick-visible")
                    }
                }), e.find(".slick-dots").length && e.hasClass("wpr-slider-dots-horizontal")) {
                var y = e.find(".slick-dots li").outerWidth() * e.find(".slick-dots li").length - parseInt(e.find(".slick-dots li span").css("margin-right"), 10);
                e.find(".slick-dots").length && e.find(".slick-dots").css("width", y), t(window).smartresize(function() {
                    setTimeout(function() {
        ...
        widgetTestimonialCarousel: function(e) {
            var i = e.find(".wpr-testimonial-carousel"),
                ...
                l = r.match(/columns--tablet\d/) ? r.match(/columns--tablet\d/).join().slice(-1) : 2,
                d = r.match(/columns--tablet_extra\d/) ? r.match(/columns--tablet_extra\d/).join().slice(-1) : l,
                p = r.match(/columns--mobile_extra\d/) ? r.match(/columns--mobile_extra\d/).join().slice(-1) : l,
        ...
        widgetSearch: function(i) {
            function a(a, n, o) {
                return 13 !== o.which && void(null != s && clearTimeout(s), s = setTimeout(() => {
                    var e = a.val();
                    t.ajax({
                        type: "POST",
                        url: WprConfig.ajaxurl,
                        ...
                        success: function(t) {
                            "" === i.find(".wpr-data-fetch ul").html() ? (i.find(".wpr-pagination-loading").hide(), i.find(".wpr-data-fetch ul").html(t), i.find(".wpr-no-more-results").fadeOut(100), setTimeout(function() {
                                t.includes("wpr-no-results") ? i.find(".wpr-ajax-search-pagination").css("display", "none") : (i.find(".wpr-ajax-search-pagination").css("display", "flex"), i.find(".wpr-data-fetch ul").find("li").length < i.find(".wpr-search-form-input").attr("number-of-results") || i.find(".wpr-data-fetch ul").find("li").length == i.find(".wpr-data-fetch ul").find("li").data("number-of-results") ? (i.find(".wpr-ajax-search-pagination").css("display", "none"), i.find(".wpr-load-more-results").fadeOut(100)) : (i.find(".wpr-ajax-search-pagination").css("display", "flex"), i.find(".wpr-load-more-results").fadeIn(100)))
                            }, 100), r = t) : t != r && (r = t, t.includes("wpr-no-results") ? (i.find(".wpr-ajax-search-pagination").css("display", "none"), i.find(".wpr-data-fetch ul").html("")) : i.find(".wpr-ajax-search-pagination").css("display", "flex"), i.find(".wpr-data-fetch ul").append(t), "" == t ? (i.find(".wpr-load-more-results").fadeOut(100), setTimeout(function() {
                                ...
                                i.find(".wpr-pagination-loading").hide(), i.find(".wpr-no-more-results").fadeIn(100)
                            }, 100)) : i.find(".wpr-load-more-results").show()), t.includes("wpr-no-results") ? (i.find(".wpr-ajax-search-pagination").css("display", "none"), i.find(".wpr-load-more-results").fadeOut()) : i.find(".wpr-ajax-search-pagination").css("display", "flex"), 2 < e.length ? (i.find(".wpr-data-fetch").slideDown(200), i.find(".wpr-data-fetch ul").fadeTo(200, 1)) : (i.find(".wpr-data-fetch").slideUp(200), i.find(".wpr-data-fetch ul").fadeTo(200, 0), setTimeout(function() {
                                i.find(".wpr-data-fetch ul").html(""), i.find(".wpr-no-results").remove()
                            }, 600), n = 0)
                        },
                        error: function(e) {
                            console.log(e)
            ...
            if ("yes" === i.find(".wpr-search-form-input").attr("ajax-search")) {
                ...
                i.find(".wpr-load-more-results").on("click", function(t) {
                    n += +i.find(".wpr-search-form-input").attr("number-of-results"), i.find(".wpr-load-more-results").hide(), i.find(".wpr-pagination-loading").css("display", "inline-block"), a(i.find(".wpr-search-form-input"), n, t)
                }), i.find(".wpr-search-form-input").on("keyup", function(r) {
                    n = 0, i.find(".wpr-data-fetch").hide(), i.find(".wpr-data-fetch ul").html(""), a(t(this), n, r)
        ...
        widgetAdvancedText: function(e) {
            ...
            function n(e) {
                ...
                if (!("yes" !== u && (b++, b === y)))
                    ...
                    l(e.find("i").eq(0), e, a, g), d(t.find("i").eq(0), t, a, g)
        ...
        widgetProgressBar: function(e) {
            ...
            var r = e.find(".wpr-progress-bar"),
                ...
                l = e.find(".wpr-prbar-circle-prline"),
                d = r.find(".wpr-prbar-hr-line-inner"),
            ...
            a(), "yes" === c.loop && setInterval(function() {
                if (i(p) && p.css({
                    ...
                    f.circleOffset;
                    l.css({
                        "stroke-dashoffset": l.css("stroke-dasharray")
                    })
                }(i(p) || i(d) || i(s)) && setTimeout(function() {
                    w.numerator({
                        toValue: 0,
            ...
            }, (h + u) * y), t(window).on("scroll", function() {
                a()
            })
        },
        ...
        widgetTabs: function(e) {
            function i(e) {
                ...
                }), n.removeClass("wpr-tab-active"), t.addClass("wpr-tab-active"), l.removeClass("wpr-tab-content-active wpr-animation-enter"), a = i.outerHeight(!0), a += parseInt(o.css("border-top-width")) + parseInt(o.css("border-bottom-width")), i.addClass("wpr-tab-content-active wpr-animation-enter"), o.css({
                    height: a
                }), setTimeout(function() {
                    o.css({
                        height: "auto"
            ...
            var s = t(".wpr-tabs", e).first(),
                ...
                n = t("> .wpr-tab", n),
                l = t("> .wpr-tab-content", o),
                d = s.data("options"),
                p = d.activeTab - 1,
                c = window.location.href.indexOf("active_tab=");
            if (-1 < c && (p = +window.location.href.substring(c, window.location.href.lastIndexOf("#")).replace("active_tab=", "") - 1), n.eq(p).addClass("wpr-tab-active"), l.eq(p).addClass("wpr-tab-content-active wpr-animation-enter"), "yes" === d.autoplay) var f = p,
        ...
        widgetContentToogle: function(e) {
            ...
            function a(t) {
                var a = d.eq(t),
                    r = p.eq(t),
                    n = "auto";
                i(t), e.hasClass("wpr-switcher-label-style-outer") || (d.removeClass("wpr-switcher-active"), a.addClass("wpr-switcher-active"), e.hasClass("wpr-switcher-style-dual") && s.attr("data-active-switcher", t + 1)), o.css({
                    height: o.outerHeight(!0)
                ...
                function e() {
                    if (s.pause(), "function" == typeof i[0].getBoundingClientRect) {
                        var e = document.documentElement.clientHeight,
                            ...
                            o = a < r.scroll_end,
                            l = n > r.scroll_start;
                        if ("viewport" === r.trigger && (l && o ? s.play() : s.pause()), "scroll" === r.trigger && l && o) {
                            s.pause();
        ...
        widgetCharts: function(e) {
            function i(t, i) {
                ...
                }, "bar_horizontal" == i.chart_type ? d.options.indexAxis = "y" : "", i.tooltips_percent && (d.options.plugins.tooltip.callbacks.label = function(e) {
                ...
                }), l = new Chart(a, d), r.forEach(function(e, t) {
                    if (0 !== e.length) {
                        var a = {};
                        a.data = e.split(i.separator), s[t] && (a.borderColor = s[t].borderColor, a.borderWidth = s[t].borderWidth, a.backgroundColor = s[t].backgroundColor, a.hoverBackgroundColor = s[t].hoverBackgroundColor, a.label = s[t].label, a.fill = s[t].fill), o.datasets.push(a), l.update()
                    }
                })
            }
            ...
            if (p.includes(a.chart_type) || delete c.scales, p.includes(a.chart_type) || "doughnut" === a.chart_type || "pie" === a.chart_type || (c.scales = {
                ...
                d = {
                    ...
                    data: t,
                    options: c
                }, "bar_horizontal" == a.chart_type ? d.options.indexAxis = "y" : "", (a.tooltips_percent || "pie" == a.chart_type || "doughnut" == a.chart_type || "polarArea" == a.chart_type) && (d.options.plugins.tooltip.callbacks.label = function(e) {
                    var t = e.dataset.label + ": ";
                ...
                }), l = new Chart(e.find(".wpr-chart"), d)
            ...
            t(window).resize(function() {
                n = 768 <= window.innerWidth ? a.line_dots_radius : 767 >= window.innerWidth ? a.line_dots_radius_mobile : 0, d.options.elements.point.radius = n, d.options.plugins.tooltip.caretSize = o
            })
        },
        ...
        widgetPostsTimeline: function(i) {
            ...
            function s(e, t, a, r, s) {
                if (s = i.find(".wpr-timeline-centered"), i.find(".wpr-both-sided-timeline").length || i.find(".wpr-one-sided-timeline").length || i.find(".wpr-one-sided-timeline-left").length) {
                    ...
                    var n = r.offset().top,
                        o = a.offset().top,
                        l = n - s.offset().top + "px",
                        d = o - n + parseInt(a.css("height").slice(0, -2));
                    e.css("top", l), e.css("height", d), "" === t ? "" : t.css("top", l)
                }
            }
            var n = 0 < i.find(".wpr-timeline-centered").length ? i.find(".wpr-timeline-centered") : "",
                ...
                l = 0 < i.find(".wpr-grid-pagination").length ? i.find(".wpr-grid-pagination") : "",
            ...
            if (0 < i.find(".wpr-timeline-centered").length && (t(window).resize(function() {
                ...
                }, 500), s(d, p, c, f, o), setTimeout(function() {
                    s(d, p, c, f, o), t(window).trigger("resize")
                ...
                var h = (void 0 === n || "load-more" !== n.attr("data-pagination")) && 10;
                n.infiniteScroll({
                ...
                n.on("load.infiniteScroll", function(e, a) {
                    u++;
                    var h = t(a).find(w).find(".wpr-timeline-entry");
                    n.infiniteScroll("appendItems", h), i.find(".wpr-one-sided-timeline").length || i.find(".wpr-one-sided-timeline-left").length || i.find(".wpr-timeline-entry").each(function(e) {
                        ...
                        duration: g,
                        once: !0
                    }), t(window).scroll(), i.find(".wpr-pagination-loading").hide(), n.data("max-pages") - 1 === u ? (i.find(".wpr-pagination-finish").fadeIn(1e3), l.delay(2e3).fadeOut(1e3)) : "load-more" === n.attr("data-pagination") && i.find(".wpr-load-more-btn").fadeIn(), d = i.find(".wpr-middle-line"), p = i.find(".wpr-timeline-fill"), c = i.find(".wpr-main-line-icon.wpr-icon:last"), f = i.find(".wpr-main-line-icon.wpr-icon").first(), o = i.find(".wpr-timeline-centered"), s(d, p, c, f, o), t(window).trigger("resize"), r(c, f)
                ...
                var y = function(e, t) {
                    ...
                    b = function(e, t) {
                        return new Promise(function(i) {
                            var a = new Swiper(e, t);
                            i(a)
                        })
                    },
                    v = i.find(".wpr-horizontal-bottom").length ? ".wpr-horizontal-bottom" : ".wpr-horizontal",
                    _ = i.find(v + ".swiper-container"),
                    x = _.data("slidestoshow");
                y(_, {
                    spaceBetween: +_.data("swiper-space-between"),
                    autoplay: "yes" === _.data("autoplay") && {
                        delay: +_.attr("data-swiper-delay")
                    },
                    on: {
                        init: function() {
                    ...
                    speed: +_.attr("data-swiper-speed"),
                    slidesPerView: _.data("slidestoshow"),
        ...
        widgetTwitterFeed: function(i) {
            function a(e) {
                var a = i.find(".wpr-twitter-feed"),
                    ...
                    g = +elementorFrontend.config.responsive.breakpoints.laptop.value,
                    h = +elementorFrontend.config.responsive.breakpoints.widescreen.value;
                n = c >= p ? e.columns_mobile ? e.columns_mobile : 1 : f >= p ? e.columns_mobile_extra ? e.columns_mobile_extra : e.columns_tablet ? e.columns_tablet : e.columns : w >= p ? e.columns_tablet ? e.columns_tablet : 2 : m >= p ? e.columns_tablet_extra ? e.columns_tablet_extra : e.columns_tablet ? e.columns_tablet : e.columns : g >= p ? e.columns_laptop ? e.columns_laptop : e.columns : h - 1 >= p ? e.columns : h <= p ? e.columns_widescreen ? e.columns_widescreen : e.columns : e.columns, 8 < n && (n = 8), n = parseInt(n), "string" == typeof n && -1 !== n.indexOf("pro") && (n = 3), r.outerWidth(Math.floor(d / n - o)), r.css("margin-bottom", l + "px"), 1 === n && r.last().css("margin-bottom", "0");
                a.isotopewpr({
                    layoutMode: s,
                    masonry: {
                        comlumnWidth: d / n,
                ...
                if (i.hasClass("wpr-twitter-feed-carousel")) {
                    var e = function(e, i) {
                            if ("undefined" == typeof Swiper) {
                                ...
                                return new a(e, i).then(function(e) {
                                    return e
                                })
                            }
                            return t(e, i)
                    ...
                    var r = i.find(".wpr-twitter-feed-cont"),
                        n = +elementorFrontend.config.responsive.breakpoints.mobile.value + 1,
                        o = +elementorFrontend.config.responsive.breakpoints.mobile_extra.value + 1,
                        l = +elementorFrontend.config.responsive.breakpoints.tablet.value + 1,
                        d = +elementorFrontend.config.responsive.breakpoints.tablet_extra.value + 1,
                        p = +elementorFrontend.config.responsive.breakpoints.laptop.value + 1,
                        c = +elementorFrontend.config.responsive.breakpoints.widescreen.value;
                    console.log(a), e(r, {
                        hashNavigation: !("yes" !== a.wpr_cs_navigation),
                ...
                d.find(".wpr-load-more-btn").hide(), d.find(".wpr-pagination-loading").css("display", "inline-block"), t.ajax({
                    ...
                    success: function(e) {
                        ...
                        a.each(function() {
                            ...
                            }), d.find(".wpr-pagination-loading").hide(), e.includes("wpr-tweet") ? d.find(".wpr-load-more-btn").fadeIn() : d.find(".wpr-pagination-finish").fadeIn(1e3)
                        }, 400), l += o.number_of_posts
                    },
                    error: function(e) {
                        console.log(e)
                    }
            ...
            if (0 < i.find(".wpr-insta-feed-content-wrap").length) {
                ...
                function w(a) {
                    if (-1 !== i.find(".wpr-insta-feed-item-lightbox").length) {
                        ...
                        }), g.lightGallery(a.lightbox), g.on("onAfterOpen.lg", function() {
                            t(".lg-outer").find(".lg-thumb-item").length && t(".lg-outer").find(".lg-thumb-item").each(function() {
                                var e = t(this).find("img").attr("src"),
                                    i = e,
                                    a = e.lastIndexOf("."),
                ...
                function m() {
                    "yes" !== g.find(".wpr-insta-feed-media-wrap").attr("data-overlay-link") || e.editorCheck() || (g.find(".wpr-insta-feed-media-wrap").css("cursor", "pointer"), g.find(".wpr-insta-feed-media-wrap").on("click", function(e) {
                        var i = e.target.className;
                        if (-1 !== i.indexOf("inner-block") || -1 !== i.indexOf("wpr-cv-inner") || -1 !== i.indexOf("wpr-insta-feed-media-hover")) {
                            ...
                            var a = t(this).find(".wpr-insta-feed-media-hover-bg").attr("data-url"),
                                a = a.replace("#new_tab", "");
                            "_blank" === g.find(".wpr-insta-feed-media-hover-bg").data("target") ? window.open(a, "_blank").focus() : window.location.href = a
                        }
                    }))
                }
                let g = i.find(".wpr-instagram-feed");
                if (g.attr("data-settings")) var a = JSON.parse(g.attr("data-settings")),
                    r = a.insta_load_more_settings;
                var s = i.attr("data-id"),
                    n = r.limit,
                    o = i.find(".wpr-grid-pagination");
                if (i.hasClass("wpr-insta-feed-layout-full-width") && (console.log(r.limit, i.find(".wpr-insta-feed-content-wrap").length), r.limit > i.find(".wpr-insta-feed-content-wrap").length && i.find(".wpr-layout-full-width").css("grid-template-columns", "repeat(" + i.find(".wpr-insta-feed-content-wrap").length + ", minmax(0, 1fr))")), i.hasClass("wpr-insta-feed-masonry") && (f(a), setTimeout(function() {
                        f(a)
                    }, 100), e.editorCheck() && (setTimeout(function() {
                        f(a)
                    }, 500), setTimeout(function() {
                    ...
                    i.find(".wpr-insta-feed-item-below-content").css({
                        float: l,
                        width: "calc((100% - " + d + "%) - " + p + "px)"
                    }), t(window).smartresize(function() {
                        l = a.media_align, d = a.media_width, p = a.media_distance, i.find(".wpr-insta-feed-item-below-content").css({
                            float: l,
                            width: "calc((100% - " + d + "%) - " + p + "px)"
                        })
                    })
                ...
                e.editorCheck() || i.find(".wpr-load-more-insta-posts").on("click", function() {
                        o.find(".wpr-load-more-btn").hide(), o.find(".wpr-pagination-loading").css("display", "inline-block"), t.ajax({
                            ...
                            success: function(e) {
                                ...
                                }), i.find(".wpr-instagram-feed").append(s), i.hasClass("wpr-insta-feed-layout-list") && (l = a.media_align, d = a.media_width, p = a.media_distance, i.find(".wpr-insta-feed-item-below-content").css({
                                    float: l,
                                    width: "calc((100% - " + d + "%) - " + p + "px)"
                                })), i.hasClass("wpr-insta-feed-masonry") && (g.isotopewpr("appended", s), g.isotopewpr("reloadItems"), g.isotopewpr("layout"), t(window).trigger("resize")), setTimeout(function() {
                                    s.each(function() {
                                        var e = t(this);
                                        setTimeout(function() {
                                ...
                                }, 400), n += r.limit, g.data("lightGallery") && g.data("lightGallery").destroy(!0), m()
                            },
                            error: function(e) {
                                console.log(e)
                            }
                        ...
                        if (i.hasClass("wpr-insta-feed-layout-carousel")) {
                            ...
                            var s = i.find(".wpr-instagram-feed-cont"),
                                n = +elementorFrontend.config.responsive.breakpoints.mobile.value + 1,
                                o = +elementorFrontend.config.responsive.breakpoints.mobile_extra.value + 1,
                                l = +elementorFrontend.config.responsive.breakpoints.tablet.value + 1,
                                d = +elementorFrontend.config.responsive.breakpoints.tablet_extra.value + 1,
                                ...
                                c = +elementorFrontend.config.responsive.breakpoints.widescreen.value;
                            e(s, {
                                hashNavigation: "yes" === r.wpr_cs_navigation,
                                autoplay: "yes" === r.wpr_cs_autoplay && {
                                    delay: +r.wpr_cs_delay
                                },
                                loop: "yes" === r.wpr_cs_loop,
                                slidesPerView: +r.wpr_cs_slides_to_show,
                                spaceBetween: +r.wpr_cs_space_between,
                                speed: +r.wpr_cs_speed,
                                pagination: "yes" === r.wpr_cs_pagination && {
                                    el: ".swiper-pagination",
                                    type: r.wpr_cs_pagination_type,
                                    clickable: "bullets" === r.wpr_cs_pagination_type
                                },
                                navigation: {
                                    prevEl: ".wpr-swiper-button-prev",
                                    nextEl: ".wpr-swiper-button-next"
                                ...
                                breakpoints: {
                                    320: {
                                        slidesPerView: +r.wpr_cs_slides_to_show_mobile
                                    },
                                    [n]: {
                                        slidesPerView: +r.wpr_cs_slides_to_show_mobile_extra
                                    },
                                    [o]: {
                                        slidesPerView: +r.wpr_cs_slides_to_show_tablet,
                                        spaceBetween: +r.wpr_cs_space_between_tablet
                                    },
                                    [l]: {
                                        slidesPerView: +r.wpr_cs_slides_to_show_tablet_extra,
                                        spaceBetween: +r.wpr_cs_space_between_tablet_extra
                                    },
                                    [d]: {
                                        slidesPerView: +r.wpr_cs_slides_to_show_laptop,
                                        spaceBetween: +r.wpr_cs_space_between_laptop
                                    },
                                    [p]: {
                                        slidesPerView: +r.wpr_cs_slides_to_show,
                                        spaceBetween: +r.wpr_cs_space_between
                                    ...
                                    [c]: {
                                        slidesPerView: +r.wpr_cs_slides_to_show_widescreen,
                                        spaceBetween: +r.wpr_cs_space_between_widescreen
                                    }
                                }
                            }), i.css("opacity", 1)
                        }
                        ...
                        g.length && g.css("opacity", 1)
                    }), e.editorCheck() && g.length && g.css("opacity", 1), m(), w(a),
                    function() {
        ...
        widgetFacebookFeed: function() {
            window.fbAsyncInit = function() {
                ...
                function(e, t, i) {
                    ...
                    e.getElementById(i) || (a = e.createElement(t), a.id = i, a.src = "https://connect.facebook.net/en_US/sdk.js", r.parentNode.insertBefore(a, r))
        ...
        widgetAdvancedAccordion: function(e) {
            ...
            "click" === n ? ("accordion" == r ? i.on("click", function() {
                var a = i.index(this);
                i.each(function(e) {
        ...
        widgetOffcanvas: function(i) {
            ...
            if (i.hasClass("wpr-offcanvas-entrance-animation-pro-sl") ? i.removeClass("wpr-offcanvas-entrance-animation-pro-sl").addClass("wpr-offcanvas-entrance-animation-fade") : i.hasClass("wpr-offcanvas-entrance-animation-pro-gr") && i.removeClass("wpr-offcanvas-entrance-animation-pro-gr").addClass("wpr-offcanvas-entrance-animation-fade"), i.hasClass("wpr-offcanvas-entrance-type-pro-ps") && i.removeClass("wpr-offcanvas-entrance-type-pro-ps").addClass("wpr-offcanvas-entrance-type-cover"), i.hasClass("wpr-offcanvas-entrance-type-push")) {
                ...
                }), "yes" === i.find(".wpr-offcanvas-container").data("offcanvas-open") && i.find(".wpr-offcanvas-trigger").trigger("click"), d();
        ...
        widgetProductAddToCart: function(e) {
            ...
            e.find("input.qty").each(function() {
                ...
                t.ajax({
                    ...
                    complete: function() {
                        r.addClass("added").removeClass("loading")
                    },
                    success: function(i) {
                        if (i.error && i.product_url) return void(window.location = i.product_url);
                        if (setTimeout(function() {
                                r.removeClass("added")
                            }, 1e3), t(document.body).trigger("wc_fragment_refresh"), t(document.body).trigger("added_to_cart", [i.fragments, i.cart_hash, r]), "undefined" == typeof wc_add_to_cart_params) return !1;
                        var a = parseInt(t(".wpr-mini-cart-icon-count").text()),
                            s = parseInt(e.find(".wpr-quantity-wrapper .qty").val());
                        t(".wpr-mini-cart-icon-count").text(a + s)
                    }
                })
            })
        },
        widgetProductMiniCart: function(i) {
            ...
            })), i.find(".wpr-mini-cart").length && i.find(".wpr-mini-cart-toggle-btn").on("click", function(a) {
            ...
            var s = new MutationObserver(function() {
                0 !== i.hasClass("wpr-mini-cart-sidebar").length && a(), i.find(".woocommerce-mini-cart-item").on("click", ".wpr-remove-item-from-mini-cart", function() {
        ...
        widgetPageMyAccount: function(i) {
            e.editorCheck() && (i.find(".woocommerce-MyAccount-content").each(function() {
                ...
                var e, a, r;
                e = i.find(".woocommerce-MyAccount-content"), e.each(function() {
                    t(this).css("display", "none")
                }), a = i.find(".woocommerce-MyAccount-navigation-link"), a.each(function() {
                    t(this).removeClass("is-active")
                }), r = t(this).attr("class").slice(t(this).attr("class").indexOf("--") + 2), t(this).addClass("is-active"), i.find("[wpr-my-account-page=\"" + r + "\"]").css("display", "block")
            }))
        },
        ...
        widgetDataTable: function(a) {
            function r() {
                if ("yes" === a.find(".wpr-table-inner-container").attr("data-entry-info")) {
                    var e = +a.find(".wpr-active-pagination-item").text(),
                        t = m * e - (m - a.find("tbody tr").length),
                        i = t - a.find("tbody tr").length + 1;
                    a.find(".wpr-entry-info").html("Showing " + i + " to " + t + " of " + h.length + " Entries.")
                }
            }

            function s() {
                f = a.find(".wpr-active-pagination-item").index(), g.each(function(e) {
                    0 == e || e == g.length - 1 || e <= f && e >= f - 2 ? t(this).css("display", "flex") : t(this).css("display", "none")
                })
            }
            ...
            function l(e, t, a) {
                for (var r = [], s = a.find(".wpr-table-row"), n = 0; n < s.length; n++) {
                    for (var o = [], l = s[n].querySelectorAll(".wpr-table-text"), p = 0; p < l.length; p++) o.push(l[p].innerText);
                    r.push(o.join(","))
                }
                d(r.join("\n"), t)
            }
            ...
            var p, c, f, w = a.find("tbody .wpr-table-row"),
                m = +a.find(".wpr-table-inner-container").attr("data-rows-per-page"),
                g = a.find(".wpr-table-custom-pagination-list-item"),
                h = a.find(".wpr-table-inner-container tbody tr"),
                u = a.find(".wpr-table-inner-container tbody");
            if ("yes" === a.find(".wpr-table-inner-container").attr("data-custom-pagination")) {
                ...
                u.html(y), s(), a.on("click", ".wpr-table-custom-pagination-list-item", function() {
                    g.removeClass("wpr-active-pagination-item"), t(this).addClass("wpr-active-pagination-item"), s(), u.hide(), p = +t(this).text(), m = +a.find(".wpr-table-inner-container").attr("data-rows-per-page"), u.html(h.filter(function(e) {
                        return e++, e > m * (p - 1) && e <= m * p
                    })), u.show(), w = a.find("tbody .wpr-table-row"), w.find(".wpr-table-tr-before-remove").each(function() {
                        t(this).removeClass("wpr-table-tr-before-remove")
                    }), r()
                }), a.find(".wpr-table-prev-next").each(function() {
                    p = +a.find(".wpr-active-pagination-item").text(), t(this).hasClass("wpr-table-custom-pagination-prev") ? t(this).on("click", function() {
                        1 < p && (g.removeClass("wpr-active-pagination-item"), p--, g.each(function(e) {
                            e++, e === p && (t(this).addClass("wpr-active-pagination-item"), p = +t(this).text())
                        }), s(), u.html(h.filter(function(e) {
                            return e++, e > m * (p - 1) && e <= m * p
                        })), w = a.find("tbody .wpr-table-row"), "" == c && u.html(w)), r()
                    }) : t(this).on("click", function() {
                        g.length > p && (g.removeClass("wpr-active-pagination-item"), p++, g.each(function(e) {
                            e++, e === p && (t(this).addClass("wpr-active-pagination-item"), p = +t(this).text())
                        }), s(), u.html(h.filter(function(e) {
                            return e++, e > m * (p - 1) && e <= m * p
                        })), w = a.find("tbody .wpr-table-row"), "" == c && u.html(w)), r()
                    }), w.find(".wpr-table-tr-before-remove").each(function() {
                        t(this).removeClass("wpr-table-tr-before-remove")
                    })
                })
            }
            if (a.find(".wpr-table-inner-container").removeClass("wpr-hide-table-before-arrange"), r(), w = a.find("tbody .wpr-table-row"), a.find(".wpr-table-live-search").keyup(function() {
                    "" === this.value ? a.find(".wpr-table-pagination-cont").removeClass("wpr-hide-pagination-on-search") : a.find(".wpr-table-pagination-cont").addClass("wpr-hide-pagination-on-search"), c = this.value.toLowerCase().trim();
                    var e = [];
                    h.each(function() {
                ...
                })), "yes" === a.find(".wpr-table-inner-container").attr("data-row-pagination") && (a.find(".wpr-table-head-row").prepend("<th class=\"wpr-table-th-pag\" style=\"vertical-align: middle;\">#</th>"), h.each(function(e) {
                ...
                b.each(function() {
                    t(this).hasClass("wpr-xls") ? t(this).on("click", function() {
                        ...
                        l("why-this-arg?", "placeholder.csv", a.find(".wpr-data-table"))
                    })
                })
            }
        },
